                ...
                <div className="o-container--small">
                    ...
                    <TranslateInOut delay={0.4} y="100%">
                        <div className="o-wysiwyg">
                            <p>
                            FFor challenge 04, we were instructed to find a project/start-up company/institution 
                            that falls in line with our GCGO. After searching via LinkedIn we came across Umurava, 
                            which is a tech startup in the Talent Management and Ed-tech spaces with a mission to 
                            build Africa's Large Workforce specialised in Digital Economy Careers. This falls in 
                            line with our Grand Challenge(GO) which is unemployment. Umurava serves as the bridge
                             between graduating and getting a job. We were able to interview Vivens Uwizeyimana 
                             is the Chief Executive Officer of Umurava .
